...
waffle2015 <- waffle::waffle(setNames(waffleData2015$a, waffleData2015$partyAbbreviation), colors = partyPalette, rows = 15, 
  equal = FALSE, size = 1) + theme(legend.text = element_text(size = 12))
```
...
```{r}
waffle::iron(waffle2015, waffle2015)
```
